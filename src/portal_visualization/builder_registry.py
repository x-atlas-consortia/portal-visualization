...
def populate_registry():
    ...
    builder_configs = [
        ...
        },
        {
            ...
            "description": "Kaggle-1 segmentation masks requiring parent's support entity for base images",
            "required_hints": ["pyramid", "is_image", "segmentation_mask"],
            "forbidden_hints": ["epic"],
            "requires_parent": True,
            "priority": PRIORITY_SPECIFIC + 25,
        },
        {
            "builder": "KaggleSegImagePyramidViewConfBuilder",
            "description": "Kaggle-2 segmentation masks (non-EPIC) with co-located base images",
            "required_hints": ["pyramid", "is_image", "segmentation_mask"],
            "forbidden_hints": ["epic"],
